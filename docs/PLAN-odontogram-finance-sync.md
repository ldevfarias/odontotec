...
_Nenhuma alteração estrutural necessária, pois as rotas de PATCH para TreatmentPlans já existem. Apenas garantir que os métodos de serviço reflitam as mudanças de status corretamente._
