...
export function authControllerResetPasswordMutationOptions<TContext = unknown>(
...
export function useAuthControllerResetPassword<TContext>(
  ...
  const baseOptions = authControllerResetPasswordMutationOptions(config) as UseMutationOptions<
    AuthControllerResetPasswordMutationResponse,
    ResponseErrorConfig<Error>,
    { data: AuthControllerResetPasswordMutationRequest },
    TContext
