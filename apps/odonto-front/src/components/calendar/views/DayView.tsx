...
import { format, isSameDay, differenceInMinutes, startOfDay, isPast } from 'date-fns';
            ...
            <div className="flex border-b border-border bg-card z-10 sticky top-0">
                ...
                <div className="flex flex-1 overflow-x-auto">
                    {professionals.length === 0 ? (
                        <div className="flex-1 p-3 flex items-center justify-center text-sm text-muted-foreground">
                ...
                <div className="flex min-w-max sm:min-w-0">
                    ...
                    <div className="flex flex-1 relative">
                                        ...
                                        return (
                                            <HoverCard key={event.id} openDelay={200} closeDelay={150}>
                                                <HoverCardTrigger asChild>
                                                    <div
                                                        className={cn(
                                                            "absolute rounded-lg p-2 text-xs overflow-hidden transition-all hover:-translate-y-0.5 hover:shadow-xl cursor-pointer z-20 group border-l-[4px] bg-card border-l-primary",
                                                            isTiny ? "p-1" : "p-2"
                                                        )}
                                                        style={{
                                                            top: `${top}px`,
                                                    ...
                                                    >
                                                        ...
                                                        <div className={cn("flex flex-col h-full", isTiny ? "gap-0" : "gap-0.5")}>
                                                            ...
                                                            {!isSmall && !isTiny && (
                                                                <div className="font-medium truncate text-foreground/90 capitalize">
                                                                    {event.patientName}
                                                                </div>
                                                            )}
                                                            <div className="mt-auto flex items-end justify-between gap-1">
                                                                ...
                                                                {!isTiny && (
                                                                    <div className="shrink-0 mb-[-1px]">
                                                                        <Avatar size="sm" className="size-5 border shadow-sm" style={{ borderColor: `${color}40` }}>
                        ...
                        {isToday && liveLineTop > 0 && (
                            ...
                            >
                                <div className="absolute left-0 h-3 w-3 rounded-full bg-red-500 shadow-lg shadow-red-500/30 -translate-y-1/2 -translate-x-1/2" />
