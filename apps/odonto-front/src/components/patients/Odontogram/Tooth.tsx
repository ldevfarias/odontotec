...
export const Tooth: React.FC<ToothProps> = ({
  ...
  return (
    <div className={cn('group/tooth flex flex-col items-center gap-1', className)}>
      <span
        className={cn(
      ...
      <div className="relative">
        <svg
          viewBox="0 0 100 100"
          className="h-8 w-8 cursor-pointer transition-transform duration-200 hover:scale-110 sm:h-12 sm:w-12"
