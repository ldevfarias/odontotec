  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent>
          {allObservations.length === 0 ? (
            <div className="text-muted-foreground flex h-32 items-center justify-center rounded-lg border-2 border-dashed px-4 text-center text-sm italic">
                    ...
                    <div key={date} className="space-y-3">
                      ...
                      <div className="space-y-3">
                        {eventsByDate[date].map((item, idx) => {
                          const isHighlighted =
                            selectedTooth && String(item.toothNumber) === selectedTooth;
