...
export const RecentActivity = ({ appointments }: RecentActivityProps) => {
    return (
        <div className="bg-white rounded-[24px] p-6 shadow-sm border border-gray-100 flex flex-col w-full h-full min-h-[400px]">
            <h3 className="text-[17px] font-bold text-gray-900 tracking-tight mb-8 mt-1">Atividade Recente</h3>

            <div className="flex flex-col gap-8 flex-1 overflow-y-auto custom-scrollbar pr-2 pb-4">
                            ...
                            <div className="flex flex-col flex-1 min-w-0 justify-center">
                                ...
                                <div className="flex items-center gap-2 mt-2">
                                    <span className="text-[11px] font-bold text-gray-400 uppercase tracking-widest">
                                        {new Date(apt.date).toLocaleTimeString('pt-BR', { hour: '2-digit', minute: '2-digit' })} AM
                                    </span>
            ...
            <button className="w-full mt-4 py-3 rounded-full border border-gray-200 text-[13px] font-bold text-gray-600 hover:bg-gray-50 hover:text-gray-900 transition-colors">
                Ver todo histórico
            </button>
        </div>
    );
