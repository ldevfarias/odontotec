...
function getThrottleMeta(methodName: keyof typeof AuthController.prototype) {
    return {
        limit: Reflect.getMetadata(LIMIT_KEY, AuthController.prototype[methodName as string]),
        ttl: Reflect.getMetadata(TTL_KEY, AuthController.prototype[methodName as string]),
    };
}
