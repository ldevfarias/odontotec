...
export class BudgetsController {
    ...
    findAllByPatient(@Param('patientId', ParseIntPipe) patientId: number, @Tenant() clinicId: number, @Query() pagination: PaginationDto) {
        return this.budgetsService.findAllByPatient(clinicId, patientId, pagination.page, pagination.limit);
    }
    ...
    update(@Param('id', ParseIntPipe) id: number, @Body() updateBudgetDto: UpdateBudgetDto, @Tenant() clinicId: number) {
