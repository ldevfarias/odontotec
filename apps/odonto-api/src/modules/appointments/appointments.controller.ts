...
export class AppointmentsController {
  ...
  async publicCancel(@Query('id') id: string, @Query('token') token: string) {
    return this.appointmentsService.updateStatusPublic(
      Number(id),
      token,
  ...
  checkAvailability(
    ...
    @Query('excludeId', new ParseIntPipe({ optional: true }))
    excludeId?: number,
  ...
  findAll(
    ...
    @Query('includeOccurrences', new ParseBoolPipe({ optional: true }))
    includeOccurrences?: boolean,
  ) {
    return this.appointmentsService.findAll(clinicId, role, userId, {
      date,
      startDate,
      endDate,
      dentistId,
  ...
  update(
    ...
    if (
      ...
      updateAppointmentDto.dentistId !== undefined
    ) {
