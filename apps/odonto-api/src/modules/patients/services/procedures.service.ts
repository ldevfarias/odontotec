...
export class ProceduresService {
    ...
    async create(createProcedureDto: CreateProcedureDto, clinicId: number): Promise<Procedure> {
    ...
    async findAllByPatient(patientId: number, clinicId: number): Promise<Procedure[]> {
    ...
    async update(id: number, updateProcedureDto: UpdateProcedureDto, clinicId: number): Promise<Procedure> {
