...
describe('getSubscriptionProActivatedEmailTemplate', () => {
    ...
    it('should include "PRO" in the subject', () => {
        const { subject } = getSubscriptionProActivatedEmailTemplate(params.adminName, params.clinicName, params.dashboardUrl);
        expect(subject).toContain('PRO');
    });

    it('should include adminName in html', () => {
        const { html } = getSubscriptionProActivatedEmailTemplate(params.adminName, params.clinicName, params.dashboardUrl);
