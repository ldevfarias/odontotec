...
const softwareApplicationSchema = {
  ...
  description:
    'Software de gestão odontológica com prontuário digital, agenda inteligente e controle financeiro. Equipe ilimitada por R$ 49,99/mês.',
  offers: {
    '@type': 'Offer',
    price: '49.99',
    priceCurrency: 'BRL',
...
export const metadata: Metadata = {
  ...
  description:
    'Software de gestão odontológica completo: prontuário digital, agenda inteligente e financeiro. Equipe ilimitada por R$ 49,99/mês. Teste grátis por 7 dias.',
  alternates: { canonical: 'https://odontoehtec.com.br' },
  openGraph: {
    title: 'OdontoEhTec | Software de Gestão Odontológica',
    description:
      'Prontuário, agenda e financeiro em um único lugar. Equipe ilimitada. R$ 49,99/mês, sem surpresas.',
    url: 'https://odontoehtec.com.br',
  ...
  twitter: {
    ...
    title: 'OdontoEhTec | Software de Gestão Odontológica',
    description:
      'Gerencie sua clínica odontológica com equipe ilimitada. R$ 49,99/mês, sem letras miúdas.',
  },
  robots: {
    index: true,
    follow: true,
