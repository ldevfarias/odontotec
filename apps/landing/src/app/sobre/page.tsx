...
export const metadata: Metadata = {
  ...
  description:
    'Conheça a história por trás do OdontoEhTec. Um software criado por brasileiros para dentistas brasileiros, com suporte em português e preço justo.',
  alternates: { canonical: 'https://odontoehtec.com.br/sobre' },
  openGraph: {
    title: 'Sobre o OdontoEhTec | Software odontológico feito no Brasil',
    description:
      'Conheça a história e a missão do OdontoEhTec: tecnologia odontológica transparente, acessível e feita no Brasil.',
      ...
      <section className="pt-36 pb-16 bg-background">
        <div className="container mx-auto px-6 md:px-12 max-w-3xl">
          ...
          <p className="body-large text-muted-foreground text-balance">
            Acreditamos que a tecnologia deve ser invisível, para que você possa focar no paciente,
            não no software.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 bg-card border-t border-border">
        <div className="container mx-auto px-6 md:px-12 max-w-3xl">
          <div className="space-y-8 body-large text-muted-foreground leading-relaxed">
            <p>
              O OdontoEhTec nasceu da frustração com softwares odontológicos inflados, caros e
              difíceis de usar. Vimos dentistas pagando por módulos que nunca usavam, sofrendo com
              interfaces antiquadas e lidando com cobranças por cada usuário adicional da equipe.
            </p>
            <p>
              Decidimos construir algo diferente: um sistema focado no que realmente importa para a
              rotina clínica. Prontuário acessível durante a consulta. Agenda que funciona sem
              treinamento. Financeiro que não exige contador. Tudo por um preço único e
              transparente.
            </p>
            <p>
              Somos um produto feito no Brasil, para dentistas brasileiros. Nosso suporte é em
              português, nossos preços são em reais, e nosso compromisso é com a simplicidade que
              libera você para exercer sua profissão com excelência.
            </p>
          </div>
        </div>
      </section>
