...
export const metadata: Metadata = {
  ...
  description:
    'Conheça todas as funcionalidades do OdontoEhTec: prontuário digital, agenda inteligente, gestão financeira e equipe ilimitada. Feito para dentistas solos e clínicas.',
  ...
  openGraph: {
    ...
    description:
      'Conheça todas as funcionalidades do OdontoEhTec: prontuário digital, agenda inteligente, gestão financeira e equipe ilimitada.',
      ...
      <section className="pt-36 pb-12 bg-background">
        <div className="container mx-auto px-6 md:px-12 max-w-3xl text-center">
          ...
          <h1 className="heading-hero mb-6 text-balance">
            Tudo que sua <span className="text-primary italic">clínica odontológica</span> precisa
            em um só lugar
          </h1>
          <p className="body-large text-muted-foreground mb-10 text-balance">
            O OdontoEhTec reúne prontuário digital, agenda inteligente, gestão financeira e
            comunicação em uma plataforma única. Sem módulos extras, sem custos escondidos.
          </p>
          <a
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="p-8 rounded-3xl border border-border bg-card">
              ...
              <h3 className="font-sans font-bold text-2xl text-foreground mb-4">
                Toda a gestão na palma da mão
              </h3>
              <p className="body-regular text-muted-foreground mb-6">
                Para o dentista autônomo, o OdontoEhTec elimina papelada e planilhas. Acesse
                prontuários, agende consultas e controle seu financeiro de qualquer lugar, direto do
                celular ou computador.
              </p>
              <ul className="space-y-3 text-sm text-foreground">
                <li className="flex items-center gap-2">
                  <span className="w-1.5 h-1.5 rounded-full bg-primary" />
                  Prontuário rápido durante a consulta
                </li>
                <li className="flex items-center gap-2">
                  <span className="w-1.5 h-1.5 rounded-full bg-primary" />
            ...
            <div className="p-8 rounded-3xl border border-primary/20 bg-primary/5">
              ...
              <h3 className="font-sans font-bold text-2xl text-foreground mb-4">
                Equipe ilimitada, controle total
              </h3>
              <p className="body-regular text-muted-foreground mb-6">
                Adicione dentistas, assistentes e recepcionistas sem pagar a mais por isso. Cada
                profissional tem acesso ao que precisa, com permissões por função. Sua clínica
                cresce sem que o software te limite.
              </p>
              <ul className="space-y-3 text-sm text-foreground">
                <li className="flex items-center gap-2">
                  <span className="w-1.5 h-1.5 rounded-full bg-primary" />
                  Agendas independentes por dentista
                </li>
                <li className="flex items-center gap-2">
                  <span className="w-1.5 h-1.5 rounded-full bg-primary" />
