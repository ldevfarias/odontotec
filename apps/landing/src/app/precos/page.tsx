...
export const metadata: Metadata = {
  ...
  description:
    'Software odontológico completo por R$ 49,99/mês. Equipe ilimitada, sem taxa de setup, cancele quando quiser. Compare com os concorrentes e veja quanto você economiza.',
  alternates: { canonical: 'https://odontoehtec.com.br/precos' },
  openGraph: {
    title: 'Planos e Preços do OdontoEhTec | R$ 49,99/mês, sem surpresas',
    description:
      'Um plano único com tudo incluso. Equipe ilimitada, prontuário, agenda e financeiro por R$ 49,99/mês.',
...
const priceSchema = {
  ...
  offers: {
    ...
    priceCurrency: 'BRL',
    description:
      'Acesso completo ao OdontoEhTec com equipe ilimitada, prontuário, agenda e financeiro.',
      ...
      <section className="pt-36 pb-4 bg-background">
        <div className="container mx-auto px-6 md:px-12 max-w-3xl text-center">
          ...
          <h1 className="heading-hero mb-6 text-balance">
            Quanto custa o OdontoEhTec? <span className="text-primary italic">R$ 49,99/mês</span>,
            tudo incluso.
          </h1>
          <p className="body-large text-muted-foreground text-balance">
            Um plano único, preço fixo, sem letras miúdas. Toda a equipe inclusa, todas as
      ...
      <section className="py-16 md:py-24 bg-card border-t border-border">
        <div className="container mx-auto px-6 md:px-12">
          ...
          <p className="body-large text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
            Softwares odontológicos tradicionais cobram por usuário e por módulo. Veja como se
            compara.
          </p>
          ...
          <div className="max-w-3xl mx-auto overflow-x-auto">
            <table className="w-full border-collapse text-sm">
              <thead>
                <tr>
                  <th className="text-left p-4 border-b border-border font-bold text-foreground">
                    Característica
                  </th>
                  <th className="text-center p-4 border-b border-border font-bold text-muted-foreground">
                    Concorrentes típicos
                  </th>
                  <th className="text-center p-4 border-b border-primary/30 bg-primary/5 font-bold text-primary">
                    OdontoEhTec
                  </th>
                </tr>
              </thead>
              <tbody>
                {[
                  ...
                  <tr key={i} className={i % 2 === 0 ? 'bg-background' : 'bg-card'}>
                    <td className="p-4 border-b border-border text-foreground font-medium">
                      {feature}
                    </td>
                    <td className="p-4 border-b border-border text-center text-muted-foreground">
                      {competitors}
                    </td>
                    <td className="p-4 border-b border-primary/20 bg-primary/5 text-center text-primary font-semibold">
                      {ours}
                    </td>
                  </tr>
                ))}
            ...
            <p className="text-xs text-muted-foreground mt-4 text-center">
              Comparação baseada em planos públicos de softwares odontológicos disponíveis no
              mercado brasileiro. Dados sujeitos a alteração.
            </p>
          </div>
        </div>
      </section>
