...
const steps = [
  {
    ...
    description:
      'Sem implantação demorada. Crie sua conta, convide sua equipe com um clique e comece a usar no mesmo minuto.',
  },
  {
    number: '02',
    title: 'Migração Transparente',
    description:
      'Importe seus pacientes de outros sistemas através de planilhas. Nossa equipe ajuda nos bastidores.',
  },
  {
    number: '03',
    title: 'Gestão no Piloto Automático',
    description:
      'A partir do dia 1, a agenda começa a disparar lembretes e o financeiro organiza o que há para receber.',
  },
];
...
export function HowItWorks() {
  return (
    <section
      id="how-it-works"
      className="py-16 md:py-24 bg-card relative z-10 border-t border-border"
    >
        ...
        <div className="flex flex-col lg:flex-row gap-16 items-start">
          ...
          >
            ...
            <motion.p variants={fadeInUp} className="body-large mb-8">
              Sistemas antigos exigem horas de treinamento. O OdontoEhTec é tão intuitivo quanto os
              aplicativos que você já usa no dia a dia.
            </motion.p>
