        ...
        <div className="container mx-auto px-6 md:px-12 relative z-10 text-center max-w-3xl">
          ...
          >
            ...
            >
              ...
              <span className="text-primary italic">invisível</span>, para que você possa focar no
              paciente, não no software.
            </motion.h2>

            <motion.p variants={fadeInUp} className="text-xl text-background/70 mb-12">
              OdontoEhTec é a resposta para softwares inflados e caros. Desenhado para ser a
              extensão natural das suas mãos.
            </motion.p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10 lg:gap-8 border-b border-border pb-10 md:pb-12 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <a href="#pricing" className="body-small hover:text-foreground transition-colors">
                    Planos & Preços
                  </a>
                </li>
                <li>
