        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          >
            ...
            <motion.h1 variants={fadeInUp} className="heading-hero mb-8 text-balance">
              ...
              <span className="text-primary/90 italic">Odontológica</span> para Dentistas e{' '}
              <span className="text-primary italic">Clínicas</span>.
            </motion.h1>

            <motion.p variants={fadeInUp} className="body-large max-w-xl mb-12 text-balance">
              Tudo o que você precisa em um único lugar. Prontuário, agenda e financeiro com
              elegância. Feito para dentistas que valorizam precisão.
            </motion.p>
            ...
            >
              ...
              >
                ...
                <svg
                  className="ml-2 w-4 h-4 group-hover:translate-x-1 transition-transform inline-block"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
              ...
              <button className="ghost-button w-full sm:w-auto">Ver planos</button>
            </motion.div>

            {/* Audience Tags */}
            <motion.div
              variants={fadeInUp}
              className="mt-10 pt-8 border-t border-border flex flex-wrap items-center gap-3 text-sm text-muted-foreground w-full"
            >
              <span className="font-medium text-foreground mr-1">Perfeito para:</span>
              <span className="flex items-center gap-1.5 bg-primary/10 text-primary px-3 py-1.5 rounded-full font-medium text-xs border border-primary/20 hover:bg-primary/20 transition-colors">
                <User className="w-3.5 h-3.5" /> Estudantes
              </span>
              <span className="flex items-center gap-1.5 bg-primary/10 text-primary px-3 py-1.5 rounded-full font-medium text-xs border border-primary/20 hover:bg-primary/20 transition-colors">
                <Users className="w-3.5 h-3.5" /> Dentista Solo
              </span>
              <span className="flex items-center gap-1.5 bg-primary/10 text-primary px-3 py-1.5 rounded-full font-medium text-xs border border-primary/20 hover:bg-primary/20 transition-colors">
                <Building className="w-3.5 h-3.5" /> Clínicas
              </span>
            </motion.div>
          </motion.div>
