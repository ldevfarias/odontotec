...
import { Users, LayoutDashboard, Calendar, Mail, FileText, ClipboardList, PenTool, Image as ImageIcon, Wallet, Plus } from "lucide-react";
            ...
            <div className="container mx-auto px-6 md:px-12">
                ...
                >
                    <motion.h2 variants={fadeInUp} className="heading-2 mb-4">
                        Projetado exclusivamente para o <br className="hidden md:block" /><span className="text-primary italic">dentista moderno</span>.
                    </motion.h2>
                    <motion.p variants={fadeInUp} className="body-large">
                        O OdontoEhTec foca no que importa: otimizar seu tempo clínico e organizar seu negócio. Zero distrações, máxima eficiência.
                    </motion.p>
                </motion.div>
                        ...
                        >
                            <div className="flex flex-col h-full">
                                <div className="flex items-center justify-between mb-6">
                                    <div className={`inline-flex p-3 rounded-2xl ${feature.highlight ? "bg-primary/10" : "bg-gray-50"}`}>
                                        {feature.icon}
                                    </div>
                                    {feature.highlight && (
                                        <div className="flex -space-x-3">
                                            <div className="w-10 h-10 rounded-full bg-blue-100 text-blue-700 flex items-center justify-center font-bold text-xs border-2 border-background shadow-sm">DR</div>
                                            <div className="w-10 h-10 rounded-full bg-emerald-100 text-emerald-700 flex items-center justify-center font-bold text-xs border-2 border-background shadow-sm">MA</div>
                                            <div className="w-10 h-10 rounded-full bg-purple-100 text-purple-700 flex items-center justify-center font-bold text-xs border-2 border-background shadow-sm">LC</div>
                                            <div
                                                ref={popoverRef}
                                                    ...
                                                    {showTeamPopover && (
                                                        ...
                                                        >
                                                            ...
                                                            <p className="text-xs text-muted-foreground mb-4 leading-relaxed">
                                                                Limitam você a <strong>1-3 agendas</strong> nos planos e cobram a mais por usuários extras.
                                                            </p>
                                                            ...
                                                            <p className="text-xs text-foreground font-medium leading-relaxed">
                                                                Agendas e profissionais <strong>ilimitados</strong> no plano Standard. Cresça sua clínica sem barreiras ou custos escondidos.
                                                            </p>
                                                        </motion.div>
                                                    )}
                                                </AnimatePresence>
                                ...
                                <div className="mt-auto">
                                    <h3 className={`font-sans font-bold mb-2 ${feature.highlight ? "text-primary text-2xl" : "text-foreground text-xl"}`}>
                                        {feature.title}
                                    </h3>
